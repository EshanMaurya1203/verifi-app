...
export function UpgradeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm sm:p-6">
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-3xl border border-border bg-background shadow-2xl">
        <button
          onClick={onClose}
        ...
        <div className="p-6 sm:p-10">
          <div className="text-center mb-10">
            ...
            <p className="mt-2 text-muted-foreground">
              Unlock advanced multi-gateway analytics, CSV export, and developer tools.
            </p>
          </div>
