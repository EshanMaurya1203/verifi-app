...
export function SignupClient() {
  ...
  // Validate internal redirect destination, default to /submit for signup
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-[420px] p-8 sm:p-10 rounded-[2rem] bg-neutral-900/40 border border-white/5 relative overflow-hidden backdrop-blur-xl shadow-2xl">
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/[0.03] border border-white/[0.06] mb-3">
            ...
            <p className="text-xs font-medium text-neutral-400 leading-relaxed mb-6">
              Join ambitious founders building instant trust with verified revenue and public profiles.
            </p>
